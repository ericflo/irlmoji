...
var IRLMOJI_API_BASIC_USER string = os.Getenv("IRLMOJI_API_BASIC_USER")
var IRLMOJI_API_BASIC_PASS string = os.Getenv("IRLMOJI_API_BASIC_PASS")
var IRLMOJI_DBURI string = os.Getenv("IRLMOJI_DBURI")
...
var DOMAIN string = GetenvDefault("DOMAIN", "localhost")
...
func Main() {
	...
	m.Use(auth.Basic(
		IRLMOJI_API_BASIC_USER,
		IRLMOJI_API_BASIC_PASS,
	))
